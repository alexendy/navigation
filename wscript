    ...
    sferes.create_variants(bld,
		source='maze_navigation.cpp',
                ...
                variants = [
                    ...
                    'NOVELTY MAZEHARD LOWERLEFT VVBIGSIZE GOALAREA1 GONE',
                    'NOVELTY MAZEHARD LOWERLEFT VVBIGSIZE GOALAREA1 GONE BD_THETA',
                    'NOVELTY ARENA1 LOWERLEFT GOALAREA1 GONE VVBIGSIZE',
                    ...
                    'NOVELTY ARENA1 LOWERLEFT GOALAREA1 VLONG2',
                    'NOVELTY MAZEHARD LOWERLEFT GOALAREA1 VLONG2 BD_THETA',
                    'NOVELTY ARENA1 LOWERLEFT GOALAREA1 VLONG2 BD_THETA',
